      ...
      >
        ...
        <div className="no-print flex items-center justify-between pb-4 mb-4 border-b border-sky-500/20">
          <div className="flex items-center gap-2 text-cyan-300">
            ...
            <span className="text-sm font-bold tracking-wider uppercase">
              Oceanographic Telemetry & Digital Twin Dossier
            </span>
          </div>
        ...
        <div className="printable-content flex flex-col gap-6 text-slate-200">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-sky-500/30">
            ...
            <div className="text-right text-xs font-mono">
              <div className="text-slate-400">
                REPORT ID: <span className="text-cyan-300 font-bold">{reportId}</span>
              </div>
              <div className="text-slate-400">
                DATE / TIME: <span className="text-white">{selectedDate} • {currentTime}</span>
              </div>
              <div className="text-emerald-400 flex items-center justify-end gap-1 mt-0.5">
                <CheckCircle className="w-3.5 h-3.5" />
                <span>Quality Control: QC Level-3 Passed</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 bg-[#0a1b42]/60 p-4 rounded-2xl border border-sky-500/20">
            <div>
              <div className="text-[10px] font-mono text-slate-400 uppercase">Target Station</div>
              <div className="text-sm font-bold text-white mt-0.5 truncate">{activeRegion?.name}</div>
            </div>
            <div>
              <div className="text-[10px] font-mono text-slate-400 uppercase">Geodetic Coordinates</div>
              <div className="text-sm font-bold font-mono text-cyan-300 mt-0.5">{activeRegion?.coords}</div>
            </div>
            <div>
              <div className="text-[10px] font-mono text-slate-400 uppercase">Gravitational Accel.</div>
              <div className="text-sm font-bold font-mono text-white mt-0.5">g(φ) = {g} m/s²</div>
            </div>
            <div>
              <div className="text-[10px] font-mono text-slate-400 uppercase">Surge / Wave Swell</div>
              <div className="text-sm font-bold font-mono text-amber-300 mt-0.5">{waveHeight} m Significant</div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-cyan-300 mb-2.5 flex items-center gap-2">
              ...
              <span>In-Situ Physical Oceanographic Telemetry</span>
            </h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5">
              <div className="p-3 rounded-xl bg-[#081533] border border-sky-500/15">
                ...
                <div className="text-[10px] text-cyan-400/80">Anomaly: +1.2°C Baseline</div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[#081533] border border-sky-500/15">
                ...
                <div className="text-[10px] text-sky-400/80">Halocline active</div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[#081533] border border-sky-500/15">
                ...
                <div className="text-[10px] text-slate-400">Bearing: 045° North-East</div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[#081533] border border-sky-500/15">
                ...
                <div className="text-[10px] text-amber-400/80">Storm Risk: {stormProb}%</div>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-xs font-bold uppercase tracking-wider text-cyan-300 flex items-center gap-2">
                ...
                <span>Full Water Column Hydrostatic Pressure Profile (UNESCO Formulation)</span>
              </h3>
              ...
              <table className="w-full text-left text-xs font-mono">
                <thead>
                  <tr className="bg-[#091b42] text-[10px] text-slate-400 uppercase border-b border-sky-500/20">
                    <th className="py-2 px-3">Depth (z)</th>
                    <th className="py-2 px-3">Pressure (dbar)</th>
                    <th className="py-2 px-3">Atmospheres</th>
                    <th className="py-2 px-3">MPa</th>
                    <th className="py-2 px-3">PSI (lb/in²)</th>
                    <th className="py-2 px-3">Density ρ (kg/m³)</th>
                    <th className="py-2 px-3">Oceanographic Zone</th>
                  </tr>
                </thead>
                <tbody>
                  {depthProfile.map((d, i) => (
                    ...
                    >
                      ...
                      <td className="py-1.5 px-3 text-[10px] text-slate-400">{d.benchmark}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-xs font-bold uppercase tracking-wider text-amber-400 flex items-center gap-2">
                ...
                <span>Nearest Coastal Beaches: Rain Forecast & Surf Safety Intelligence</span>
              </h3>
              <span className="text-[10px] font-mono text-slate-400">
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <div className="text-sm font-bold text-white flex items-center gap-1.5">
                        ...
                        <span className="text-[10px] font-normal text-slate-400 font-mono">({b.distanceKm} km away)</span>
                      </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 my-2 text-center">
                    <div className="bg-[#040e26] p-1.5 rounded-xl">
                      <div className="text-[9px] text-slate-400 uppercase">Rain Probability</div>
                      <div className="text-sm font-bold font-mono text-amber-300">{b.rainProbability}%</div>
                    </div>
                    <div className="bg-[#040e26] p-1.5 rounded-xl">
                      <div className="text-[9px] text-slate-400 uppercase">24h Precip</div>
                      <div className="text-sm font-bold font-mono text-cyan-300">{b.total24hPrecipMm} mm</div>
                    </div>
                    <div className="bg-[#040e26] p-1.5 rounded-xl">
                      <div className="text-[9px] text-slate-400 uppercase">Surf Breakers</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            ...
            <div className="p-4 rounded-2xl bg-[#061433] border border-sky-500/20">
              <h4 className="text-xs font-bold uppercase tracking-wider text-sky-200 mb-2">
                Predictive Model vs In-Situ QC Metrics
              </h4>
              <div className="grid grid-cols-3 gap-2 text-center mb-2">
                <div className="bg-[#0a1d48] p-2 rounded-xl">
                  <div className="text-[9px] text-slate-400">Root Mean Sq (RMSE)</div>
                  <div className="text-xs font-mono font-bold text-cyan-300">{VALIDATION_METRICS.rmse}</div>
                </div>
                <div className="bg-[#0a1d48] p-2 rounded-xl">
                  <div className="text-[9px] text-slate-400">Systemic Bias</div>
                  <div className="text-xs font-mono font-bold text-amber-300">{VALIDATION_METRICS.bias}</div>
                </div>
                <div className="bg-[#0a1d48] p-2 rounded-xl">
                  <div className="text-[9px] text-slate-400">Pearson Correlation</div>
                  <div className="text-xs font-mono font-bold text-emerald-300">{VALIDATION_METRICS.correlation}</div>
                </div>
              </div>
              <p className="text-[10px] text-slate-400">
                49 synchronized in-situ observing platforms reporting (24 Moored Buoys, 18 Argo Profiling Floats, 7 SVP Drifters).
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-b from-red-950/30 to-[#07132e] border border-red-500/30">
              <div className="flex items-center gap-2 text-xs font-bold text-red-400 uppercase tracking-wider mb-1">
                ...
                <span>Marine Threat & Advisory Status</span>
              </div>
              <div className="text-xs font-bold text-white mb-1">
                {activeRegion?.activeStorm?.name || 'Low Pressure Marine Front'}
              </div>
              <p className="text-[11px] text-slate-300 leading-relaxed mb-2">
                {activeRegion?.activeStorm?.rainfallForecast || 'Convective squalls and elevated wind waves detected in sector.'}
              </p>
              <div className="text-[10px] font-mono text-red-300 bg-red-500/20 px-2 py-1 rounded-lg border border-red-500/30 inline-block">
                Storm Advisory: Central Pressure {activeRegion?.activeStorm?.pressure || '995 hPa'} • Surge {activeRegion?.activeStorm?.surge || '1.5m'}
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-sky-500/20 flex flex-col md:flex-row md:items-center justify-between text-[11px] text-slate-400 font-mono">
            <div>
              Automated Digital Twin Telemetry Engine • OceanVision 3D Core v2.4
            </div>
            <div className="text-right">
              Validated by INCOIS / NOAA / Copernicus Standards
            </div>
          </div>
        </div>
        ...
        <div className="no-print flex items-center justify-between pt-6 mt-4 border-t border-sky-500/20">
          <span className="text-xs text-slate-400">
            Press Print or use browser Ctrl+P to save as formatted PDF document.
          </span>
